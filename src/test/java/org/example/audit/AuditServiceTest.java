...
public class AuditServiceTest {
    ...
    void testAuditEntryCreatedOnProjectUpdate() {
        ...
        // Act
        AuditLog auditLog = auditService.recordAuditEvent(
    ...
    void testAuditEntryImmutability() {
        ...
        assertThrows(UnsupportedOperationException.class, () -> {
            auditService.updateAuditLog(auditLogId, new AuditLog());
        });
    ...
    void testAuditHistoryQueryByDateRange() {
        ...
        // Act
        List<AuditLog> auditHistory = auditService.getAuditHistoryByDateRange(
                testProjectId,
                earlier,
                later
        );
    ...
    void testAuditHistoryQueryByEventType() {
        ...
        // Act
        List<AuditLog> statusUpdates = auditService.getAuditHistoryByEventType(
                testProjectId,
                AuditEventType.PROJECT_STATUS_UPDATED
        );
    ...
    void testMultipleAuditEntriesOrderedByDate() {
        ...
        // Act
        List<AuditLog> auditHistory = auditService.getAuditHistoryByProjectId(testProjectId);
